            ...
            try {
                ...
                if ($search === false) {
                    ...
                    $save = \Index\Register\Model::execute($this, array(
                        ...
                        // Facebook
                        'social' => 1,
                        'visited' => self::$cfg->new_members_active == 1 ? 1 : 0,
                        'lastvisited' => self::$cfg->new_members_active == 1 ? time() : 0,
                    ...
                    if ($search['active'] == 1) {
                        ...
                        // log
                        \Index\Log\Model::add($save['id'], 'index', 'User', '{LNG_Login} (Facebook)', $save['id']);
